...
class Dataloader:
    ...
    def __init__(self, mode=None):
        ...
        # x = pickle.load(open("C:\\Users\\Angelo\\PycharmProjects\\multi-modal-deep-learning\\features\\data_{}.p".format(self.MODE.lower()),"rb"))
        x = pickle.load(open("../features/data_{}.p".format(self.MODE.lower()),"rb"))
        ...
        self.class_names = list(label_index.keys())
    ...
    def load_audio_data(self, ):
        ...
        AUDIO_PATH = "../features/audio_embeddings_feature_selection_{}.pkl".format(self.MODE.lower())
    ...
    def load_bimodal_data(self,):
        ...
        # TEXT_UNIMODAL = "C:\\Users\\Angelo\\PycharmProjects\\multi-modal-deep-learning\\features\\text_{}.pkl".format(self.MODE.lower())
        TEXT_UNIMODAL = "../features/text_{}.pkl".format(self.MODE.lower())
        AUDIO_UNIMODAL = "../features/audio_{}.pkl".format(self.MODE.lower())
        ...
        def print_shapes(data_dict, name):
            for key, value in data_dict.items():
                print(f"{name}[{key}].shape = {value.shape}")



        print("Text length", len(train_text_x))
        # print_shapes(train_text_x, "text")
        # print_shapes(train_audio_x, "audio")
